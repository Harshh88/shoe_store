  ...
  return (
    <div className="bg-[#141414] border border-[#222222] rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between min-h-[190px] group hover:border-zinc-800 transition-all duration-300">
      <div>
        ...
        <p className="text-xs font-bold text-[#D9FA53] tracking-wide uppercase">
          {subtitle}
        </p>
      </div>

      <div className="mt-5 z-10">
        <button className="bg-[#EBFFA2] hover:bg-white text-black text-xs font-black tracking-wider px-5 py-2.5 rounded-full transition-colors font-mono uppercase">
          {actionText}
        </button>
      </div>

      {/* Skewed background representation block layout */}
