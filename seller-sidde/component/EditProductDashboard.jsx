...
export default function EditProductDashboard({ product, onBack, onSubmit, onSaveSuccess }) {
  ...
  const [previewUrl, setPreviewUrl] = useState(product?.url || '');
        ...
        <form onSubmit={handleFormSubmit}>
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-3xl md:text-5xl font-black tracking-tight font-mono text-white">EDIT PRODUCT</h1>
            </div>
            <button 
              type="button"
              onClick={handleReset}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8 items-start">
            ...
            <div className="md:col-span-2">
              ...
              >
                {previewUrl ? (
                  <img src={previewUrl} alt="Preview" className="absolute inset-0 w-full h-full object-contain p-4 bg-[#090909]" />
                ) : (
                  <>
