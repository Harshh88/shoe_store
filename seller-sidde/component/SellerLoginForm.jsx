...
export default function SellerLoginForm({
    ...
    return (
        <main className="min-h-screen w-full flex flex-col bg-[#0E0E0E] text-[#D4D4D8] selection:bg-[#F7FFB0] selection:text-black">
            {/* Navbar */}
            <nav className="w-full max-w-7xl mx-auto px-6 py-4 flex items-center">
            ...
            {/* Form Section */}
            <section className="flex-1 w-full max-w-xl mx-auto px-6 py-12 flex flex-col justify-start items-center">
                <form 
                ...
                >
                    ...
                    <div className="w-full flex flex-col gap-2">
                        <label className="text-xs font-semibold tracking-wider text-[#A1A1AA] uppercase font-mono" htmlFor="email">
                            EMAIL ADDRESS
                        </label>
                        <input
                    ...
                    {/* Password Input */}
                    <div className="w-full flex flex-col gap-2">
                        <label className="text-xs font-semibold tracking-wider text-[#A1A1AA] uppercase font-mono" htmlFor="password">
                            PASSWORD
                        </label>
                        <input
                            className="w-full bg-[#1A1A1A] border border-[#2A2A2A] focus:border-[#F7FFB0] focus:ring-1 focus:ring-[#F7FFB0] outline-none h-12 sm:h-14 px-4 rounded-xl font-mono text-sm text-white transition-all placeholder:text-gray-600"
