...
export default function AddProductButton({ isOpen, onClick }) {
  return (
    <div className="mb-6 md:mb-8">
      <button 
        onClick={onClick}
        className="w-full bg-[#D9FA53] hover:bg-[#cbe947] text-black font-bold py-4 px-6 rounded-full flex items-center justify-center gap-2 transition-all duration-300 transform active:scale-[0.99]"
      >
