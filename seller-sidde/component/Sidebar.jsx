...
import { LayoutDashboard, ShoppingBag, ShoppingCart, Calendar, User, Settings, Menu, X } from 'lucide-react';
...
export default function Sidebar({ currentNav = "Dashboard", onNavChange = () => {}, isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 h-screen w-64 bg-[#141414] border-r border-[#1F1F1F] p-6 flex flex-col justify-between z-40 shrink-0 transition-transform duration-300 ease-in-out ${
        isOpen ? 'translate-x-0' : '-translate-x-full'
      }`}>
        <div>
          <div className="flex items-center gap-3 mb-10 pt-16">
            {/* <Menu className="w-5 h-5 text-[#F7FFB0]" /> */}
