...
export default function ProfileForm({ formData, isEditing, setIsEditing, handleChange, handleSubmit }) {
    ...
    <div className="w-full max-w-md mx-auto bg-[#111113] border border-zinc-900 rounded-3xl p-6 text-white shadow-2xl">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {!isEditing && (
          <button
            ...
            className="flex items-center gap-1.5 bg-[#D4F953] text-black text-xs font-bold px-4 py-2 rounded-full hover:bg-lime-400 transition-all shadow-md"
          >
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="relative">
          ...
          {isEditing && (
            <button className="absolute bottom-0 right-0 bg-[#D4F953] text-black p-1.5 rounded-full hover:bg-lime-400 transition-colors shadow">
      ...
      {!isEditing ? (
        <div className="space-y-5">
          ...
          <p className="text-center text-[11px] text-zinc-600 font-medium">
            Password and sensitive details are hidden for security.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-[#D4F953] hover:bg-lime-400 text-black font-bold uppercase tracking-wider text-xs py-3.5 rounded-xl transition-all duration-200 mt-2 shadow-lg"
          >
